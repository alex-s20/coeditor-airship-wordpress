...
<div class="coeditor-airship__tabs">
	<div id="tab1" class="coeditor-airship__tab-pane">
	...
	<div id="tab2" class="coeditor-airship__tab-pane">
		<div class="coeditor-airship__past-notifications">
			<h2><?php esc_html_e('Past Notifications (Coming Soon)', 'coeditor-airship'); ?></h2>
			<p><?php esc_html_e('This section will display past notifications once available.', 'coeditor-airship'); ?>
			</p>
		</div>
	</div>
