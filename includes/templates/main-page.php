...
<h2 class="nav-tab-wrapper coeditor-airship__tab-nav">
	<a href="#main-tab1"
		class="nav-tab coeditor-airship__nav-tab"><?php esc_html_e( 'Scheduled Notifications', 'coeditor-airship' ); ?></a>
	<a href="#main-tab2"
		class="nav-tab coeditor-airship__nav-tab"><?php esc_html_e( 'Past Notifications', 'coeditor-airship' ); ?></a>
</h2>

<div class="coeditor-airship__tabs">
	<div id="main-tab1" class="coeditor-airship__tab-pane">
						...
						<div class="coeditor-airship__scheduled-notification-item">
							...
							<div class="coeditor-airship__scheduled-notification-preview-web">
								<div class="coeditor-airship__web-icon">
									<img src="<?php echo esc_url( COEDITOR_AIRSHIP_ASSETS . '/images/web.png' ); ?>"
										alt="Web Icon">
								</div>
							...
							<div class="coeditor-airship__scheduled-notification-preview-ios">
								<div class="coeditor-airship__apple-icon">
									<img src="<?php echo esc_url( COEDITOR_AIRSHIP_ASSETS . '/images/apple.png' ); ?>"
										alt="Apple Icon">
								</div>
							...
							<table class="coeditor-airship__scheduled-notification-details">
									...
									<td>
										<ul>
											...
											<?php if ( isset( $notification['schedule']['recurring'] ) ) : ?>
												<li><strong><?php esc_html_e( 'Recurring Schedule:', 'coeditor-airship' ); ?></strong>
												</li>
								...
								<?php if ( ! empty( $notification['push']['notification']['web']['actions']['open']['content'] ) ) : ?>
									<tr>
										<td><strong><?php esc_html_e( 'Web Deep Link:', 'coeditor-airship' ); ?></strong></td>
										<td>
											<a href="<?php echo esc_url( $notification['push']['notification']['web']['actions']['open']['content'] ); ?>"
												target="_blank">
												<?php echo esc_html( $notification['push']['notification']['web']['actions']['open']['content'] ); ?>
											</a>
										</td>
									</tr>
								<?php endif; ?>
	...
	<div id="main-tab2" class="coeditor-airship__tab-pane">
		<div class="coeditor-airship__past-notifications">
			<h2><?php esc_html_e( 'Past Notifications', 'coeditor-airship' ); ?></h2>
			<p><?php esc_html_e( 'Nothing is showing? Click on tab again.', 'coeditor-airship' ); ?>
			</p>
		</div>
	</div>
